      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-16'>
        ...
        >
          ...
          <p className='text-slate-700 dark:text-slate-300 leading-relaxed text-lg mb-8'>
            It was a group project built in the hackathon E&apos;summit 2022. Though we did not win, the project was selected as a top 10.
            The frontend is basic HTML and CSS with Bootstrap framework elements. The backend was made using PHP. In the team, I was in charge of the frontend layout and design implementation.
          </p>
          
          <div className='flex flex-wrap gap-4'>
            <a href='https://github.com/Only-Learner/SPORTS-CORNER' target='_blank' rel='noreferrer'>
              <button className='px-6 py-3 text-sm flex items-center gap-2'>
                Code
              </button>
            </a>
            <a href='https://sports-corner.000webhostapp.com/' target='_blank' rel='noreferrer'>
        ...
        >
          <div className='glass-card p-6 w-full h-full'>
            ...
            <div className='flex flex-col gap-3'>
              {['PHP', 'HTML', 'CSS', 'Bootstrap'].map((tech, i) => (
